...
/*
Monthly trends for gsearch sessions and orders so that we can showcase the growth
*/ 
...
/*
Same as above case but splitting out nonbrand and brand campaigns separately. 
*/ 
...
/*
Website performance improvements over the course of the first 8 months. 
...
/*
6.	For the gsearch lander test, estimating the revenue that test earned,  
using nonbrand sessions and revenue to calculate incremental value
*/ 
...
/*
7.	For the landing page test we analyzed previously, showing a full conversion funnel 
from each of the two pages to orders ,time period used (Jun 19 – Jul 28).
*/ 
...
/*
 To quantify the impact of billing test Analyzing the lift generated 
